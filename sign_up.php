	...
	require_once('../database/dbConfig.php');
	 ...
	 if(isset($_POST["SignUpBtn"])) {
        ...
        if(mysqli_num_rows(mysqli_query($conn,$check_phone))>0){
           ...
           $sql = "INSERT INTO taxi_admin (adminName, adminPhone, adminPassword)
          ...
          if($result){
            ...
            echo "<script> alert('Sign up unsucessful')</script>";
          }
        }
	} 
?>
...
<div id="wrapper">
	<article id="Sign Up">
		<form method="post" onsubmit = "return validatePassword(password.value, password2.value)" action="sign_in.php">
			<div class= "container">
				<h1>Sign Up</h1>
				<hr>
				<p>Please fill in</p>
				<!--<hr>-->
					...
					<label for = "cell" >
					<b> cell </b></label>
					<input type = "text" pattern = "0[0-9]{9}" title = "10 digits, start with zero(0)" name = "cell" required>
					<label for = "password" >
					<b> password </b></label>
					<input type = "password"  name = "password" required>
					<label for = "re-password" >
					<b> re-enter password </b></label>
					<input type = "password" name = "password2" id = "re-enter password" required></form><br>
				<ul class="actions">
